...
protected:
    ...
    void inc_handle_refs(OpaqueHandle& handle);
    /* Decrement handle reference counter. */
    void dec_handle_refs(OpaqueHandle& handle);

    /* Destroy a resource. */
    void destroy_resource(OpaqueHandle& handle);
