...
public:
     ...
     */
    PLATFORM_SPECIFIC Result<Buffer> create_buffer(std::string name, BufferUsage usage, u64 count, u64 stride = 0) = 0;
    ...
    PLATFORM_SPECIFIC Result<Image> create_image(std::string name, Texture texture, bool is_depth = false, bool is_stencil = false, u32 mip = 0u, u32 layer = 0u) = 0;
    ...
    PLATFORM_SPECIFIC Result<void> resize_texture(Texture& texture, Size3D size, TextureMeta meta) = 0;
